    ...
    var addPhotos = function(arr) {
        ...
        for (var i = 0; i < arr.length; i++) {
            ...
            if (arr[i][3] == markerRed) {
                ...
                html = '<li><div class="crown-photo-x"><img src="src/img/%photo_name%" alt="%ALT%" class="tooltip"><h3 class="new-label"><span>%NAME%<br>%HEIGHT%<br></span></h3></div></div></li>';

            } else {

                html = '<li><div class="crown-photo"><img src="src/img/%photo_name%" alt="%ALT%" class="tooltip" title="%TITLE%"><h3 class="new-label"><span>%NAME%<br>%HEIGHT%<br></span></h3><div class="flag-icon"><h3><i class="ion-ios-flag-outline"></i><div>%DATE%</div></h3></div></div></li>';
            }
    ...
    var addPhotosMobile = function(arr) {
        ...
        var html, newHtml, el;
            ...
            for (var i = 0; i < 10; i++) {
                ...
                html = '<div class="swiper-slide"><img src="src/img/%photo_name%" /><div class="label-mobile">%NAME% %HEIGHT% &mdash; %DATE%</div></div>';
